...
@section('content')
    <div class="container flex-col gap-2 w-4/5 lg:w-2/3 mx-auto pt-2 flex justify-center">
        ...
        <div class="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-4 mb-4">
            <a href="{{ route('management.contracts') }}" class="bg-gray-100 rounded-md p-4 cursor-pointer hover:bg-gray-300">
            ...
            <a href="{{ route('docs.index') }}" class="bg-gray-100 rounded-md p-4 cursor-pointer hover:bg-gray-300">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
            ...
            <a href="#" class="bg-gray-100 rounded-md p-4 cursor-pointer hover:bg-gray-300">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
