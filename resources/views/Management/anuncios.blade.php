...
@section('title', 'RêntHûb.es | Tus anuncios')
@section('header')
            ...
            <div class="container flex-col gap-4 w-4/5 w-full mx-auto pt-2 flex justify-center mb-4 z-10">
                ...
                <div class="w-full h-full flex justify-center ">
                    <div class="w-1/2 flex flex-col justify-center h-1/2 items-center py-24">
                        ...
                        <p class="text-center text-lg">Prueba a crear un anuncio <a href="/anuncio/new" class="underline">aquí</a></p>
                    </div>

                </div>
                @else
                    @foreach ($userAnunciosList as $anuncio)
