...
Echo.private('users.{{ Auth()->User()->id }}')
    ...
    <header class="px-3 z-10 bg-white sticky top-0 w-full py-2 mt-16 lg:mt-0">

        <div class="justify-between flex items-center pb-2">

            <div class="flex items-center gap-2">
                <h5 class="font-extrabold text-2xl">Mensajes</h5>
            </div>
            <button @click="type='request'" :class="{ '': type == 'request' }"
                class="inline-flex justify-center items-center gap-x-1 text-sm font-medium px-3 lg:px-5 py-1  lg:py-2.5  hover:underline ">
                Solicitudes
            </button>
        ...
        <div class="flex gap-3 items-start justify-start mx-0 py-2 bg-white">
            <div class="border-r px-2">
                <button @click="type='all'" :class="{ 'bg-gray-200 border-0 text-black': type == 'all' }"
                    class="inline-flex justify-center items-center rounded-full gap-x-1 text-xs font-medium px-3 lg:px-5 py-1  lg:py-2.5 bg-gray-100 ">
                    Todos
                </button>
            </div>

            <button @click="type='anuncios'" :class="{ 'bg-gray-200 border-0 text-black': type == 'anuncios' }"
                class="inline-flex justify-center items-center rounded-full gap-x-1 text-xs font-medium px-3 lg:px-5 py-1  lg:py-2.5  bg-gray-100 ">
                Anuncios
            </button>
            <button @click="type='contracts'" :class="{ 'bg-gray-200 border-0 text-black': type == 'contracts' }"
                class="inline-flex justify-center items-center rounded-full gap-x-1 text-xs font-medium px-3 lg:px-5 py-1  lg:py-2.5  bg-gray-100 ">
                Contratos
            </button>
        </div>
